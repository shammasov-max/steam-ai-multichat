export const TestData = {
  ...
  scoringScenarios: {
    agreement: [
      { role: 'USER', content: 'Tell me about your premium service' },
      { role: 'ASSISTANT', content: 'Our premium service offers personalized coaching for $29.99/month' },
      { role: 'USER', content: 'That sounds good. Yes, I agree to subscribe to the premium service.' },
      { role: 'ASSISTANT', content: 'Great! Let me set that up for you.' },
      { role: 'USER', content: 'Thank you! I\'m excited to start.' }
    ],
    highEngagement: [
  ...
  performanceData: {
    bulkDialogs: Array.from({ length: 100 }, (_, i) => ({
      ...
      init: `Initial instructions for test ${i}`
    })),
