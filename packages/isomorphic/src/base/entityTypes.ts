 ...
 */
export type EntityActionCreators<TName extends string, TReducers extends EntityReducersMap<TName, any>> = {
 ...
 */
export type SliceReducersFromEntityReducers<TName extends string, TEntity, TReducers extends EntityReducersMap<TName, TEntity>> = {
